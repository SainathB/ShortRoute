...
/********************** This is the code that you can change***********************/
  ...
  no_of_vertices=15;
 edges=[2,2,2,2,2,4,4,2,3,3,2,2,2,2,2];
  x=[40,46,163,171,232,270,307,378,449,483,580,648,574,672,767];
  y=[186,324,216,304,252,395,206,115,291,143,98,68,349,270,132];
  edge_info;
