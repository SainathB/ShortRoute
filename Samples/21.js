...
/********************** This is the code that you can change***********************/
  ...
  no_of_vertices=16;
  edges=[2,2,3,3,2,3,3,2,2,2,2,2,4,2,2,2];
  x=[68,126,170,230,211,273,330,381,336,424,381,471,580,610,672,703];
  y=[215,138,260,140,368,274,193,102,343,196,431,294,264,175,297,212];
  edge_info;
